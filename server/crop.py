...
os.makedirs('/Users/zeus/Desktop/DZONEGADGET/client/public/images/products', exist_ok=True)
...
def crop_and_save(img, num_items, prefix):
    ...
    for i in range(num_items):
        ...
        cropped.save(f'/Users/zeus/Desktop/DZONEGADGET/client/public/images/products/{prefix}_{i+1}.jpg', 'JPEG')
