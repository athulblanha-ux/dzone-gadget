...
export default function Category() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-b from-primary-50 to-white dark:from-dark-card dark:to-dark-bg py-12 mb-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="w-20 h-20 mx-auto bg-gradient-primary rounded-2xl flex items-center justify-center text-4xl mb-4 shadow-lg">{catRes.icon}</div>
