...
import { FiHeart, FiShoppingCart, FiTruck, FiShield, FiStar, FiMinus, FiPlus, FiCheck } from 'react-icons/fi';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            {/* Features */}
            <div className="grid grid-cols-2 gap-4 border-t border-gray-100 dark:border-dark-border pt-8">
              <div className="flex items-center gap-3 text-sm text-gray-600 dark:text-dark-muted"><div className="w-10 h-10 rounded-full bg-primary-50 text-primary-500 flex items-center justify-center"><FiTruck size={20} /></div> Free Delivery over ₹499</div>
              <div className="flex items-center gap-3 text-sm text-gray-600 dark:text-dark-muted"><div className="w-10 h-10 rounded-full bg-green-50 text-green-500 flex items-center justify-center"><FiShield size={20} /></div> 100% Safe & Certified</div>
            </div>
          </div>
        </div>
      </div>
